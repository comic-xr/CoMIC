...
def training(dataset, opt, pipe, testing_iterations, saving_iterations):
    ...
    for iteration in range(1, opt.iterations + 1):
        ...
        if iteration == opt.warm_up + 100:
            ...
            render_pkg_re = render_foveated(viewpoint_cam, gaussians, scene.forest, pipe, background, d_xyz, d_rotation, d_scaling, gaze_point, is_6dof=dataset.is_6dof, L=2, w0=0.1, m=0.2, e0=0.1)
