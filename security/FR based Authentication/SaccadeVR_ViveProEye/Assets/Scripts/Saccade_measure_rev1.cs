...
public class Saccade_measure_rev1 : MonoBehaviour
{
    ...
    // 
    // ********************************************************************************************************************
    public static string UserID = "Eye_User15_cat";       // Definte ID number such as 001, ABC001, etc.
    public static string Path = Directory.GetCurrentDirectory();
    string File_Path = Directory.GetCurrentDirectory() + "\\StandardSaccade_" + UserID + ".csv";
    ...
    private static long CurrentTime, MeasureEndTime = 0;
    ...
    void Data_txt()
    {
        ...
        File.AppendAllText("StandardSaccade_" + UserID + ".csv", variable);
    }
    ...
    private static void EyeCallback(ref EyeData_v2 eye_data)
    {
        ...
        while (cnt_callback < maxframe_count)
        {
            ...
            if (error == ViveSR.Error.WORK)
            {
                ...
                // --------------------------------------------------------------------------------------------------------
                MeasureTime = DateTime.Now.ToString("HH_mm_ss_ffffff");
                ...
                File.AppendAllText("StandardSaccade_" + UserID + ".csv", value);
    ...
    void SaccadeTask()
    {
        ...
        if (cnt_saccade == 0)
        {
            ...
            File.AppendAllText("Saccade_Start_Time_" + UserID + ".csv", timingSaccadevariable);
    ...
    private IEnumerator TargetAppear(float fp_time, int direction, int sac_order)
    {
        ...
        File.AppendAllText("Saccade_Start_Time_" + UserID + ".csv", timingSaccadevalue);
