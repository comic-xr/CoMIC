// receiver.js - WebRTC Receiver for performance testing with duration after connection
...
async function runReceiver() {
  ...
  try {
    ...
    const browser = await puppeteer.launch({
      ...
      userDataDir: userDataDir, // Use the unique profile directory
      ...
      args: [
        ...
        '--disable-session-crashed-bubble', // Prevent "Restore pages?" dialog
        '--disable-infobars', // Disable Chrome's info bars
    ...
    await page.evaluate(() => {
      ...
      // Add function to get stream constraints
