...
# fixed parameters
ssh_client="68.183.104.252"     
ssh_client_port="22" 
client_iface="eth0"
client_IP="165.22.185.209" 
...
target_duration=30
useTCPDUMP="false"
key="~/.ssh/id_rsa"  # Default SSH key location
use_iperf="false"
just_cleanup="false"
TCP_CC="cubic"
iperf_receiver="68.183.104.252"
webrtc_server="68.183.104.252"
webrtc_port="4000"
test_video="test-video-1080p.mp4" #"test-video-720p.mp4" 
...
# network emulation at client
# Add egress (upload) limiting rules
